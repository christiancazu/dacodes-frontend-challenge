...
const moduleMap = {'@ant-design/icons':{get:()=>()=>__federation_import(new URL('__federation_shared_@ant-design/icons-DU8bJ7TK.js', import.meta.url).href),import:true},'@tanstack/react-query':{get:()=>()=>__federation_import(new URL('__federation_shared_@tanstack/react-query-BKmDD9O3.js', import.meta.url).href),import:true},'antd':{get:()=>()=>__federation_import(new URL('__federation_shared_antd-XjSWEq03.js', import.meta.url).href),import:true},'react':{get:()=>()=>__federation_import(new URL('__federation_shared_react-DoKb58Ht.js', import.meta.url).href),import:true},'react-dom':{get:()=>()=>__federation_import(new URL('__federation_shared_react-dom-pEkape4k.js', import.meta.url).href),import:true}};
