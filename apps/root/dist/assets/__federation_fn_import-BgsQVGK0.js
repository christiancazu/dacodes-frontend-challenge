...
const moduleMap = {'axios':{get:()=>()=>__federation_import(new URL('__federation_shared_axios-CSjHYxlI.js', import.meta.url).href),import:true},'@ant-design/icons':{get:()=>()=>__federation_import(new URL('__federation_shared_@ant-design/icons-jNkUU0Dd.js', import.meta.url).href),import:true},'@tanstack/react-query':{get:()=>()=>__federation_import(new URL('__federation_shared_@tanstack/react-query-CLXmmFND.js', import.meta.url).href),import:true},'antd':{get:()=>()=>__federation_import(new URL('__federation_shared_antd-P4yGEEx0.js', import.meta.url).href),import:true},'react':{get:()=>()=>__federation_import(new URL('__federation_shared_react-DoKb58Ht.js', import.meta.url).href),import:true},'react-dom':{get:()=>()=>__federation_import(new URL('__federation_shared_react-dom-DU2-P0kt.js', import.meta.url).href),import:true}};
